...
(function() {
    ...
    _.extend(Model.prototype, Events, {
        ...
        fetch : function(options) {
            ...
            return (this.sync || Backbone.sync).call(this, 'read', this, options, this.directory, this.encryption);
        },
        ...
        save : function(key, value, options) {
            ...
            var xhr = (this.sync || Backbone.sync).call(this, method, this, options, this.directory, this.encryption);
            if (options.wait)
        ...
        destroy : function(options) {
            ...
            options.error = Backbone.wrapError(options.error, model, options);
            var xhr = (this.sync || Backbone.sync).call(this, 'delete', this, options, this.directory, this.encryption);
            if (!options.wait)
                triggerDestroy();
            return xhr;
        },
    ...
    _.extend(Collection.prototype, Events, {
        ...
        fetch : function(options) {
            ...
            options.success = function(resp, status, xhr) {
                if (options.update) {
                    collection.update(resp, options);
                } else {
